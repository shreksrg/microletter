...
<body>
<div class="easyui-panel" title="编辑项目" style="width:100%; height: 100%">
    ...
    if ($item) {
        ...
        <div style="padding:10px 60px 20px 60px">
                ...
                <table cellpadding="5">
                    <tr>
                        ...
                        <td><input class="easyui-textbox" type="text" size="100" name="title"
                                   data-options="required:true" value="<?= $item['title'] ?>">
                        </td>
                    </tr>
                    <tr>
                        <td>人品等级:</td>
                    ...
                    <tr>
                        ...
                        <td><input class="easyui-textbox" name="desc" data-options="multiline:true,required:true"
                                   style="width: 320px;height:120px" value="<?= $item['desc'] ?>"></td>
                    </tr>
                </table>
                    ...
                    <table cellpadding="5">
                        ...
                        <tr>
                            ...
                            <td><input class="easyui-textbox" type="text" size="100" name="goods_title"
                                       data-options="required:true" value="<?= $goods['title'] ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>产地:</td>
                        ...
                        <tr>
                            <td>价格:</td>
                            <td><input class="easyui-textbox" type="text" name="goods_price"
                                       data-options="required:true" value="<?= $goods['price'] ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>图片:</td>
            ...
            <div style="padding:5px 0;">
                <a id="btnSave" href="<?= SITE_URL ?>/admin/itemman/edit" class="easyui-linkbutton">保存</a>
...
<script>
    $('[name=grade]').val(<?=$item['grade']?>);
    $('[name=status]').val(<?=$item['status']?>);
    $('[name=goods_source]').val(<?=$goods['origin']?>);
</script>
